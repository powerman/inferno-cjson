...
test()
{
	...
	t = Token.new(array of byte "  \"-2.3e-3\" ,  null  ");
	...
	t = Token.new(array of byte "+123.456");
	ok(t.getr() == 123.456, "+123.456");

	t = Token.new(array of byte "123.456e1");
	ok(t.getr() == 1234.56, "123.456e1");

	t = Token.new(array of byte "123.456E-1");
	ok(t.getr() == 12.3456, "123.456E-1");

	t = Token.new(array of byte "1E3");
	ok(t.getr() == 1E3, "1E3");

	t = Token.new(array of byte "123.456E-1.1");
	ok(t.getr() == 12.3456, "123.456E-1");
